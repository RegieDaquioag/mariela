...
//*******************************************************************************
double avgPower(vector<double> v, int n, ofstream& fout);
...
//*******************************************************************************
double avgMagnitude(vector<double> v, int n, ofstream& fout);
...
//*******************************************************************************
double zeroCross(vector<double> v, int n, ofstream& fout);
...
//*******************************************************************************
double variances(vector<double> v, double n, double mean, ofstream& fout);
...
int main()
{
	...
	variances(maria, element1, meanM, fout1);
	variances(ransom, element2, meanR, fout1);
	double varM = variances(maria, element1, meanM, fout1);
	double varR = variances(ransom, element2, meanR, fout1);
...
//******************************************************************	
	...
	fout1 << avgPower(maria, element1, fout1) << setw(15);
	fout1 << avgPower(ransom, element2, fout1) << setw(15);      
	fout1 << percentage(avgPower(maria, element1, fout1), avgPower(ransom, element2, fout1))  << endl;
		 
	fout1 << setw(15) << "Magnitude" << setw(15);
	fout1 << avgMagnitude(maria, element1, fout1) << setw(15);
	fout1 << avgMagnitude(ransom, element2, fout1) << setw(15);      
	fout1 << percentage(avgMagnitude(maria, element1, fout1), avgMagnitude(ransom, element2, fout1))  << endl;
	
	fout1 << setw(15) << "Zero Crossings" << setw(15);
	fout1 << zeroCross(maria, element1, fout1) << setw(15);
	fout1 << zeroCross(ransom, element2, fout1) << setw(15);      
	fout1 << percentage(zeroCross(maria, element1, fout1), zeroCross(ransom, element2, fout1)) << endl;
